...
import 'package:flutter_font_picker_fork_tony/flutter_font_picker.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:pro_image_editor_tony/designs/whatsapp/whatsapp_text_appbar.dart';
...
import 'package:pro_image_editor_tony/mixins/converted_configs.dart';
...
class TextEditorState extends State<TextEditor>
  ...
  late TextStyle selectedTextStyle = GoogleFonts.roboto();
  int _numLines = 0;
              ...
              child: FontPicker(
                ...
                onFontChanged: (font) {
                  setState(() {
                    ...
                    selectedTextStyle = font.toTextStyle();
                  });
                },
  ...
  TextStyle getTextStyle(Color getTextColor, double initFontSize) {
    TextStyle newSelectedTextStyle = selectedTextStyle.copyWith(
        color: getTextColor,
  ...
  Widget _buildDoneBtn() {
    return IconButton(
      ...
      iconSize: 28,
      onPressed: () => done(getTextStyle(_getTextColor, _getTextFontSize)),
    );
  }
  ...
  Widget _buildBody() {
    ...
    return GestureDetector(
      ...
      onTap: () => done(getTextStyle(_getTextColor, _getTextFontSize)),
      child: Stack(
        children: [
          _buildTextField(),
          Align(
          ...
          if (imageEditorTheme.editorMode == ThemeEditorMode.whatsapp)
            WhatsAppTextAppBar(
              configs: widget.configs,
              align: align,
              onDone: () => done(getTextStyle(_getTextColor, _getTextFontSize)),
                ...
                children: [
                  Hero(
                    ...
                    child: RoundedBackgroundText(_textCtrl.text,
                        ...
                        textAlign: align,
                        style: getTextStyle(_getTextColor, _getTextFontSize)),
                  ),
                  IntrinsicWidth(
                    child: TextField(
